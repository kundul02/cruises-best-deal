...
const REGIONS = [
  {
    ...
    dates: "5 Aug — Dec 2026",
    json: "research/summer-med-july-2026.json",
    accent: "orange",
    callout:
      "Marseille, Barcelona, Genoa, Civitavecchia, Palermo и др. · 5 Aug — Dec 2026. Семья 2–3 чел., 17 лет = взрослый тариф.",
  ...
  },
  {
    ...
    accent: "teal",
    callout:
      "Copenhagen, Hamburg, Kiel, Baltic, Norway. Фьорды осенью и repositioning до Dec 2026. 17 лет = взрослый тариф.",
